...
@Component({
  selector: 'app-exercicio-slide-aula-tres',
  templateUrl: './exercicio-slide-aula-tres.component.html',
  styleUrls: ['./exercicio-slide-aula-tres.component.css']
})
export class ExercicioSlideAulaTresComponent implements OnInit {
